...
namespace teste.Controllers
{
    public class EnderecoesController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Endereco.Include(e => e.Cidade);
        ...
        public async Task<IActionResult> Create([Bind("Id,Logradouto,Numero,Bairro,CidadeId")] Endereco endereco)
        {
            ...
            ViewData["CidadeId"] = new SelectList(_context.Cidade, "Id", "Nome", endereco.CidadeId);
            return View(endereco);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Logradouto,Numero,Bairro,CidadeId")] Endereco endereco)
        {
            if (id != endereco.Id)
            {
                return NotFound();
